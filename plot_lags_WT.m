...
load(['.\Results\WindTunnel_processed\M_lags' num2str(i) '_' num2str(j)],'R','Q')
...
legend('Mean of solutions','Standard deviation of solutions')  
xlim([0 4])
xticks([1:1:3])
...
save(['./Results/WindTunnel_processed/meanQR'],'meanQb','meanRb','stdQ','stdR');
...
% print -dpng -painters -r400 R_WT_legend
% 
% figure(2)
% set(gcf,'Units','inches');
% set(gcf,'Position',[0 1 12 5 ])
...
%     'PaperPosition',[0 0 screenposition(3:4)],...
%     'PaperSize',[screenposition(3:4)]);
% print -dpng -painters -r400 Q_WT_legend
